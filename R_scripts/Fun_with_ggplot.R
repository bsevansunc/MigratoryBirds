...
#Read in dataframe
NNW_data <- read.csv("encounters.csv", header=TRUE)
...
#Mofidying colors
ggplot(NNW_data, aes(x=wing, fill=species))+geom_histogram(binwidth=1)+facet_grid(species~., scales="free")+scale_x_continuous("wing chord/mm", breaks=c(30,40,50,60,70,80,90,100,110,120,130,140), labels=c(30,40,50,60,70,80,90,100,110,120,130,140),limits=c(30,140))+scale_fill_manual(values=c("#F77F2F","#FAF05F", "#ED361A", "#FCD853", "#F2511F", "#B4DB64", "#2892C7", "#64B0AC" ))

#Changing the base theme
ggplot(NNW_data, aes(x=wing, fill=species))+geom_histogram(binwidth=1)+facet_grid(species~., scales="free")+scale_x_continuous("wing chord/mm", breaks=c(30,40,50,60,70,80,90,100,110,120,130,140), labels=c(30,40,50,60,70,80,90,100,110,120,130,140),limits=c(30,140))+scale_fill_manual(values=c("#F77F2F","#FAF05F", "#ED361A", "#FCD853", "#F2511F", "#B4DB64", "#2892C7", "#64B0AC" ))+theme_bw()

#Modifying elements of the theme
ggplot(NNW_data, aes(x=wing, fill=species))+geom_histogram(binwidth=1)+facet_grid(species~., scales="free")+scale_x_continuous("wing chord/mm", breaks=c(30,40,50,60,70,80,90,100,110,120,130,140), labels=c(30,40,50,60,70,80,90,100,110,120,130,140),limits=c(30,140))+scale_fill_manual(values=c("#F77F2F","#FAF05F", "#ED361A", "#FCD853", "#F2511F", "#B4DB64", "#2892C7", "#64B0AC" ))+theme(legend.position="none")+theme(axis.text.x=element_text(size=9, color="black"), axis.text.y=element_text(color="black"))+theme(axis.line = element_line(colour = "black"), axis.ticks=element_line(color="black"),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       panel.grid.major = element_blank(),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             panel.grid.minor = element_blank())                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  

#Adding a title
ggplot(NNW_data, aes(x=wing, fill=species))+geom_histogram(binwidth=1)+facet_grid(species~., scales="free")+scale_x_continuous("wing chord/mm", breaks=c(30,40,50,60,70,80,90,100,110,120,130,140), labels=c(30,40,50,60,70,80,90,100,110,120,130,140),limits=c(30,140))+scale_fill_manual(values=c("#F77F2F","#FAF05F", "#ED361A", "#FCD853", "#F2511F", "#B4DB64", "#2892C7", "#64B0AC" ))+theme_bw()+ggtitle("Histograms of Wing Chord by Species")
...
GRCA_DC <- read.csv("GRCA_DC.csv", header=TRUE)
head(GRCA_DC)
GRCA_DC2 <- na.omit(GRCA_DC)
head(GRCA_DC2)

#Can you guys write the code to summarize sample size, mean wing and se of wing by age and sex using ddply?
